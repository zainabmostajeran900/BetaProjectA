  ...
  return (
    <div className="w-full h-22 bg-[#F1F1F1] px-5 shadow shadow-gray-300 flex flex-wrap items-center justify-center gap-3 md:gap-5">
      ...
      <div className="flex flex-wrap justify-center items-center gap-3 lg:gap-5 text-[#111111]">
        <button className="font-bold hidden lg:block bg-white px-4 py-3 text-sm rounded-lg hover:bg-gray-700 hover:text-white">
          دانستنی‌های سفر
        </button>
        <button className="font-bold hidden lg:block bg-white px-4 py-3 text-sm rounded-lg hover:bg-gray-700 hover:text-white">
          جاذبه‌های گردشگری
        ...
        <button className="font-bold bg-purple-100 px-7 py-3  text-white text-sm rounded-lg hover:bg-gray-700">
          اماکن تفریحی
        </button>
        <button className="font-bold bg-white px-4 py-3  hover:bg-gray-700 text-sm rounded-lg hover:text-white">
          اماکن توریستی
        </button>
        <button className="font-bold bg-white px-4 py-3  hover:bg-gray-700 text-sm rounded-lg hover:text-white">
          همه مقالات
