    ...
    <div className=" w-full bg-gray-100  px-8">
      ...
      <div className="flex flex-col items-center gap-y-4 justify-center lg:flex-row lg:justify-between  lg:items-center gap-x-3 ">
        <div className=" flex flex-col item-center justify-center lg:flex-row lg:items-start lg:justify-center lg:gap-x-3 gap-x-5 rounded-lg">
          ...
          <div className="flex flex-col gap-y-5 text-gray-400 font-bold lg:p-0 pt-4">
            <p className="border-r-2 h-12 flex items-center p-6 lg:p-2">گردش خنک تابستانی</p>
            <p className="border-r-2 h-12 flex items-center p-6 lg:p-2" >هفت خان رستم تهران کجاست</p>
            <div className="border-r-2 border-r-[#4156D9] h-12 flex items-center p-4 lg:p-2">
            <p className="text-[#4156D9] bg-gray-200  p-2 rounded-lg ">
              سفربا خودروی شخصی در جزیره کیش
            </p>
            </div>
            <p className="border-r-2 h-12 flex items-center p-6 lg:p-2">ارتاریخچه جنگل</p>
            <p className="border-r-2 h-12 flex items-center p-6 lg:p-2">سفربا وسایل نقلیه عمومی به کجا</p>
            <p className="border-r-2 h-12 flex items-center p-6 lg:p-2">چرا به جنگل ابرباید رفت؟</p>
          </div>
        </div>
        <div className="hidden lg:flex lg:flex-col gap-y-4 items-center justify-center">
          <div className="border-r-4 border-r-[#4156D9]  rounded-xs ">
