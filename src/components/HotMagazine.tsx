export const HotMagazine: React.FC = () => {
  return (
    <div className=" w-full bg-gray-100  px-8">
      <h1 className="block font-bold text-xl pb-6">
        مجله های داغ و محبوب اماکن تاریخی
      </h1>
      <div className="flex justify-between gap-x-3">
        <div className="flex items-center justify-center gap-x-3 rounded-lg">
          <div>
            <img src="/public/Group 1833.png" alt="" />
          </div>
          <div className="flex flex-col  gap-y-4 text-gray-400 font-bold">
